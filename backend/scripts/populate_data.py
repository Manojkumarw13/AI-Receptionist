...
from sqlalchemy.orm import sessionmaker  # FIXED: Added missing import
import sys

# Add project root to path
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), '..')))

from database.connection import init_star_db, get_star_session, get_session
from database.models import Doctor, DiseaseSpecialty, User
from database.models_star import (
    Base,  # FIXED: Added missing import
